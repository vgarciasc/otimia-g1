...
class MyBranch(CPX_CB.BranchCallback):
    ...
    def __call__(self):
        ...
        if branching == 1: # Branch on variable with most fractional value (nearest to 0.5)
        ...
        elif branching == 2: # Branch on random variable
            # RANDOM BRANCHING
...
def create_client(client_socket):
    ...
    client_socket.sendall(b"Client connected successfully")
...
if __name__ == "__main__":
    ...
    threading.Thread(target=create_client, args=(client_socket,)).start()
